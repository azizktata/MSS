...
// Deep Basin Carrier (variant /2) — shared by both the /2 route and the default "/" route.
// `activePath` lets the variant switcher highlight /2 even when rendered at "/".
export default function VariantTwo({ activePath }: { activePath?: string } = {}) {
  return (
    <main className="mss v2" id="top">
      <SiteNav items={NAV} activePath={activePath} />
